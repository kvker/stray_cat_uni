<template>
  <view>
    <view class="login-img">
      <view class="owl-login" :class="hide_eyes && 'password'">
    ...
    <view class="login-form">
      <form @submit="formSubmit">
        ...
        <view class="form-input">
          <input type="password" name="password" placeholder="密码" @focus="passwordStatusChange" @blur="passwordStatusChange" />
        </view>
  ...
  export default {
    ...
    methods: {
      ...
      async formSubmit(e) {
        ...
        let is_email = email.trim().match(/\w+([-+.]\w+)*@\w+([-.]\w+)*\.\w+([-.]\w+)*/)
